...
function play(){
  gameStatus="start";
  document.getElementById('status').innerHTML="status: game is starting in few seconds";
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Click on the play button to Start and Play ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
